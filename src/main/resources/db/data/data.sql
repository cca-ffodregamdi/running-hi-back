-- dummy data insert
-- 즐겨찾기 테이블
INSERT INTO tbl_bookmark(member_no, folder_no, post_no)
VALUES (1, 1, 1);

------즐겨찾기 폴더 테이블
INSERT INTO tbl_bookmark_folder(folder_no, folder_name, member_no)
VALUES (1, 'testFolder_1', 1);
INSERT INTO tbl_bookmark_folder(folder_no, folder_name, member_no)
VALUES (2, 'testFolder_2', 2);

INSERT INTO tbl_comment(comment_no, comment_content, comment_date, comment_status, comment_report_cnt, member_no,
                        member_post_no)
